...
python run_finetune_siamese.py \
	--model_pretrained_checkpoint /ceph/alebrink/contrastive-product-matching/reports/contrastive/dblp-googlescholar-clean-$AUG$PREBATCH-$LR-$TEMP-$PREEPOCHS-roberta-base/pytorch_model.bin \
    --do_train \
    ...
    --output_dir /ceph/alebrink/table-augmentation-framework/contrastive-product-matching/reports/contrastive-ft-siamese/dblp-googlescholar-clean-$AUG$PREBATCH-$PREAUG$LR-$TEMP-$PREEPOCHS-$EPOCHS-frozen-roberta-base/ \
