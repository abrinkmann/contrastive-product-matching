...
python run_pretraining_deepmatcher.py \
    ...
    --output_dir /ceph/alebrink/development/table-augmentation-framework/contrastive-product-matching/reports/contrastive/abtbuy-clean-$AUG$BATCH-$LR-$TEMP-roberta-base/ \
	--temperature=$TEMP \
